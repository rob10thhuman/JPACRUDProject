...
<html lang="en">
  ...
  <head>
    ...
    <title>Edge Marketing - The Agency Colorado Springs</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">Edge Marketing</span>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">The Agency Colorado Springs · 309 E St Vrain 80903 · 719-440-6626
            <a href="mailto:name@email.com">edge@theagencycoloradosprings.com</a>
          </div>
          <p class="lead mb-5">Mission statement here.</p>
...
<div class="container"> 
 ...
 --> 
	...
	<form action="quarterlyReport.do" method="GET">
		<input type="submit" name="quarterlyReport" value="Quarterly Report" />
	</form>
	...
	<form action="getAVGYTDStatsByAgent.do" method="GET">
		<em>Agent NRDS:</em> <input type="text" name="NRDS" value="Enter NRDS # for YTD sums" />
		<input type="submit" value="Search" />
	</form>
	
	<form action="getBrokerageDeals.do" method="GET">
		<em>Brokerage YTD stats:</em> <input type="text" name="brokerage" value="Enter Brokerage" />
		<input type="submit" value="Search" />
	</form>
	
	<form action="getHomesInDateRangeAsHyperlinks.do" method="GET">
		<em>All Homes Sold in DB:</em> <input type="text" name="closedDate" value="e.g., 2018-10-01" />
		<input type="submit" value="Search" />
	</form>
		
	
	<form action="getZipYearToDate.do" method="GET">
		<em>Zip Code:</em> <input type="text" name="zipCode" value="Enter zip for YTD stats" />
		<input type="submit" value="Search" />
	</form>
	
	<form action="getZipReport.do" method="GET">
		<input type="submit" name="ZipReport" value="ZipReport" />
	</form>
	
	<form action="getBrokerageListRankingYTD.do" method="GET">
		<em>Brokerage List Rankings:<BR></em>
		</B> <input type="text" name="startDate" value="Start date" />
		<input type="text" name="endDate" value="End date" />
		<input type="submit" value="Search" />
	</form>
	
	<form action="getHotSubAreasReport.do" method="GET">
		<em>Hot Sales Sub  Area Report:</em><BR>
	...
	<form action="getHotAreasReport.do" method="GET">
		<em>Hot Sales Area Report:</em><BR>
		<input type="text" name="startDate" value="Start date" />
		<input type="text" name="endDate" value="End date or blank for YTD" />
		<input type="submit" value="Search" />
	</form>
